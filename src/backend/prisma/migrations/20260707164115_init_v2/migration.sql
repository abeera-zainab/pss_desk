...
-- CreateEnum
CREATE TYPE "TaskStatus" AS ENUM ('LOCKED', 'PENDING', 'IN_PROGRESS', 'SUBMITTED', 'UNDER_REVIEW', 'COMPLETED', 'REJECTED');
...
-- CreateIndex
CREATE INDEX "Case_assignedManagerId_idx" ON "Case"("assignedManagerId");

-- CreateIndex
CREATE INDEX "Case_status_idx" ON "Case"("status");

-- CreateIndex
CREATE UNIQUE INDEX "Task_dependsOnTaskId_key" ON "Task"("dependsOnTaskId");
...
-- AddForeignKey
ALTER TABLE "Case" ADD CONSTRAINT "Case_assignedManagerId_fkey" FOREIGN KEY ("assignedManagerId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
